...
export default function HomeHero() {
  return (
    <section
      ...
      <BackgroundTitle variant="dark" className="top-15 md:top-27.5 lg:top-41.25 text-bg-sm md:text-bg-md lg:text-[340px] xl:text-[420px] 2xl:text-bg-xl">
        TECHNICIANS
      </BackgroundTitle>
      ...
      <Container>
        <div className="relative z-10 flex justify-between items-center md:items-start gap-0 md:gap-5 lg:gap-0 pt-10 md:pt-37.25 lg:pt-52">
          <div className="w-full max-w-85 md:max-w-69.25 lg:max-w-130 xl:max-w-150 2xl:max-w-171 mx-auto md:mx-0 shrink-0">
            <p
              className="font-body text-lg lg:text-4xl xl:text-[44px] 2xl:text-6xl leading-6 lg:leading-10.5 xl:leading-none
            ...
            <button
              className="relative mt-3.25 lg:mt-7.5 xl:mt-8.75 2xl:mt-10
                text-base lg:text-md xl:text-md 2xl:text-lg font-bold leading-6.5 uppercase
